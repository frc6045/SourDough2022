...
private final Joystick driver_Joy = new Joystick(0);
  ...
  */
  private RobotContainer() {
    ...
    SmartDashboard.putData("Dump_Run: defaultSpeed", new Dump_Run(0.35, m_flyWheel));
    SmartDashboard.putData("Climb_Run: DefaultClimbSpeed", new Climb_Run(0.8, m_climb));

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=SMARTDASHBOARD
    // Configure the button bindings
    SmartDashboard.putData("CG_DumpCargo", new CG_DumpCargo( m_tunnle, m_flyWheel, m_intakeArm ));
    ...
    m_chooser.setDefaultOption("Autonomous Command", new CG_SimpleAuto(m_tunnle, m_flyWheel, m_intakeArm, m_driveTrain));
  ...
  private void configureButtonBindings() {
    ...
    final JoystickButton joystickButton1 = new JoystickButton(driver_Joy, 1);        
    joystickButton1.whileHeld(new CG_DumpCargo( m_tunnle, m_flyWheel, m_intakeArm ) ,true);
        SmartDashboard.putData("Joystick Button 1",new CG_DumpCargo( m_tunnle, m_flyWheel, m_intakeArm ) );
        // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=BUTTONS
// Create some buttons
final JoystickButton operator_Button_1 = new JoystickButton(operatorJoy, 1);        
operator_Button_1.whileHeld(new Climb_Run(0.8, m_climb) ,true);
    SmartDashboard.putData("operator_Button_1",new Climb_Run(0.8, m_climb) );
